...
def bulkapi_device(stc):
    ...
    dev = stc.create('emulateddevice', project, {'name': 'devd', 'AffiliationPort-targets': port1})  
	...
	cret = stc.bulkcreate("emulateddevice",
				{'name': 'devperform', 'AffiliationPort-targets': port1, 'under': "project1",
				 'BgpRouterConfig': {'name': 'mybgprouter1', 'AsNum': 166,
